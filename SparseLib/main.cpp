...
//funcao para executar os comandos
void executeCommand(const string& comando, istringstream& cc, vector<SparseMatrix*>& vetorDeMatrizes) {
 ...
 int main() {
    ...
    while(true){
        ...
        if(comando == "exit" || comando == "Exit"){
            ...
            executeCommand(comando, cc, vetorDeMatrizes);
        }
    }
    // limpeza final das matrizes
    for (auto matriz : vetorDeMatrizes) {
        delete matriz;
    }
    vetorDeMatrizes.clear();
